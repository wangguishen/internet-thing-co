...
module.exports = {
  dev: {
    ...
    proxyTable: {
      ...
      '/iot-frame': {
        // target: 'http://172.19.4.216:5555',//张文本地环境
        // target: 'http://172.16.35.95:5555',//测试环境
        // target: 'http://172.19.4.151:6666', //姜清秀本地环境
        // target: 'http://192.168.1.234:5555', //张梦蝶本地环境
      ...
      '/algorithm': {
        target: 'http://172.19.4.195:888',
        // target: 'http://frame-company.sunmath.cn',
        changeOrigin: true,
        pathRewrite: {
          '^/algorithm': '/algorithm'
        }
